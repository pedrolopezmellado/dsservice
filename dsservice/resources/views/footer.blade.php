...
<footer class="footer mt-auto py-3 bg-light">
    <div class="row" style="background-color:#e8f8f5">
        <div class="col-md-6">
            <h3 class="text-muted">Sobre Nosotros: </h3></br>
        ...
        <div class="col-md-6">
            ...
            <ul>
            <li>Teléfono de contacto: 965550055</li>
            <li>Email: dsservices@gmail.com </li>
            <li>Horario de atención: 9am - 8pm</li>
            </ul>
        </div>
        
    </div>
    <div class="container-fluid">
        <p class="text-center">&copy; Copyright 2021 - DSServices</p>
    </div>
</footer>